...
class LRUCache(Cache):
    ...
    def clear(self):
        ...
        with self.lock:
            ...
            # With self._data already clear, that peak should not exceed what
            # we normally use.
            self._data = {}
            size = self.size
        ...
        with self.lock:
            ...
            while 1:
                ...
                if ref == True:
                    ...
                    # Maybe oldkey was not in self._data to begin with. If it
    ...
    def invalidate(self, key):
        ...
        entry = self._data.pop(key, _MARKER)
...
class ExpiringLRUCache(Cache):
    ...
    def clear(self):
        ...
        with self.lock:
            ...
            # With self._data already clear, that peak should not exceed what
            # we normally use.
            # self._data contains (pos, val, expires) triplets
            self._data = {}
            size = self.size
            self.clock_keys = [_MARKER] * size
            self.clock_refs = [False] * size
