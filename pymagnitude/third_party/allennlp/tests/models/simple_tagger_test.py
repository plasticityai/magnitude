...
class SimpleTaggerTest(ModelTestCase):
    def setUp(self):
        ...
        self.set_up_model(self.FIXTURES_ROOT / u'simple_tagger' / u'experiment.json',
    ...
    def test_forward_on_instances_ignores_loss_key_when_batched(self):
        ...
        for output in batch_outputs:
            assert not u"loss" in list(output.keys())
        ...
        assert u"loss" in list(single_output.keys())
