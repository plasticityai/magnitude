...
class NlvrCoverageSemanticParserTest(ModelTestCase):
    def setUp(self):
        ...
        self.set_up_model(self.FIXTURES_ROOT / u"semantic_parsing" /
                          u"nlvr_coverage_semantic_parser" / u"experiment.json",
                          self.FIXTURES_ROOT / u"data" / u"nlvr" / u"sample_grouped_data.jsonl")
    ...
    def test_ungrouped_model_can_train_save_and_load(self):
        ...
        self.ensure_model_can_train_save_and_load(self.FIXTURES_ROOT / u"semantic_parsing" /
                                                  u"nlvr_coverage_semantic_parser" / u"ungrouped_experiment.json")

    def test_mml_initialized_model_can_train_save_and_load(self):
        # pylint: disable=line-too-long
        self.ensure_model_can_train_save_and_load(self.FIXTURES_ROOT / u"semantic_parsing" /
                                                  u"nlvr_coverage_semantic_parser" / u"mml_init_experiment.json")

    def test_get_checklist_info(self):
        # Creating a fake all_actions field where actions 0, 2 and 4 are terminal productions.
        all_actions = [(u'<o,o> -> top', True, None),
                       (u'fake_action', True, None),
                       (u'c -> color_black', True, None),
                       (u'fake_action2', True, None),
                       (u'e -> 6', True, None)]
