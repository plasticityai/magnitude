...
class TestInitializers(AllenNlpTestCase):
    def setUp(self):
        ...
        logging.getLogger(u'allennlp.nn.initializers').disabled = False
    ...
    def test_from_params_string(self):
        Initializer.from_params(params=u"eye")
    ...
    def test_block_orthogonal_can_initialize(self):
        ...
        def test_block_is_orthogonal(block)        :
    ...
    def test_uniform_unit_scaling_can_initialize(self):
        tensor = torch.zeros([10, 6])
        uniform_unit_scaling(tensor, u"linear")
        ...
        uniform_unit_scaling(tensor, u"relu")
