...
class TestBiMPMMatching(AllenNlpTestCase):
    def test_forward(self):
        ...
        ml_fw = BiMpmMatching.from_params(Params({u"is_forward": True, u"num_perspectives": l}))
        ml_bw = BiMpmMatching.from_params(Params({u"is_forward": False, u"num_perspectives": l}))
