...
class DecomposableAttention(Model):
    ...
    def forward(self,  # type: ignore
        ...
        output_dict = {u"label_logits": label_logits,
        ...
        if metadata is not None:
            output_dict[u"premise_tokens"] = [x[u"premise_tokens"] for x in metadata]
            output_dict[u"hypothesis_tokens"] = [x[u"hypothesis_tokens"] for x in metadata]
...
DecomposableAttention = Model.register(u"decomposable_attention")(DecomposableAttention)
