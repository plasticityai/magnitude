...
class AttachmentScores(Metric):
    ...
    def get_metric(self, reset       = False):
        ...
        if reset:
            self.reset()
        return {
                u"UAS": unlabeled_attachment_score,
                u"LAS": labeled_attachment_score,
                u"UEM": unlabeled_exact_match,
                u"LEM": labeled_exact_match
        }
...
AttachmentScores = Metric.register(u"attachment_scores")(AttachmentScores)
