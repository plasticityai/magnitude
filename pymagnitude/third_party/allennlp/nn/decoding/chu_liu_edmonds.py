...
def decode_mst(energy               ,
    ...
    if has_labels and energy.ndim != 3:
        raise ConfigurationError(u"The dimension of the energy array is not equal to 3.")
    elif not has_labels and energy.ndim != 2:
        raise ConfigurationError(u"The dimension of the energy array is not equal to 2.")
    ...
    for node1 in range(length):
        ...
        representatives.append(set([node1]))
    ...
    for child, parent in list(final_edges.items()):
        heads[child] = parent
        if has_labels:
...
def chu_liu_edmonds(length     ,
    ...
    for node in range(length):
        ...
        in_edge_weight = float(u"-inf")
        in_edge = -1
        out_edge_weight = float(u"-inf")
        out_edge = -1
